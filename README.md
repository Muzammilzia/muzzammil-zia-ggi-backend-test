...
> PS: I had very limited time to scaffold this project as this came in weekday, so had to do it along with my job. As a result, I have implemented a minimal but completely functional version with all requirements mentioned in the assessment.
